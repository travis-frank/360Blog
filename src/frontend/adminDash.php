  ...
  <div class="admin-container">
    <div class="sidebar">
      ...
      <ul class="nav flex-column">
        <li class="nav-item"><a href="#" class="nav-link active" data-section="users">Manage Users</a></li>
        <li class="nav-item"><a href="#" class="nav-link" data-section="posts">Manage Posts</a></li>
        <li class="nav-item"><a href="#" class="nav-link" data-section="topics">Manage Topics</a></li>
        <li class="nav-item"><a href="#" class="nav-link" data-section="analytics">Analytics</a></li>
      </ul>
    </div>
    ...
    <div class="main-content">
      ...
      <div id="posts-section" style="display: none;">
        <div class="content-header">
          <h2>Manage Posts</h2>
          <div class="header-actions">
            <input type="text" class="form-control post-search-input" placeholder="Search posts by title..." />
          </div>
        </div>
        <table class="table">
          <thead>
        ...
        <div class="add-topic-form mt-4">
          ...
          <form id="add-topic-form">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="topicName" name="topic_name" placeholder="Enter new topic" required />
            </div>
